...
const Hero: NextPage = () => {
  return (
    <div className="flex flex-col px-10 py-10">
      <h1 className="text-center text-8xl">Why Sourcery?</h1>
      <div className="flex flex-row pt-16 justify-around">
        <div className="bg-gradient-to-r from-violet-700 to-blue-300 w-2/5 text-left rounded-xl">
        ...
        <div className="text-left rounded-xl bg-gradient-to-r from-violet-700 to-blue-300 text-white text-2xl px-10 py-10 flex flex-col w-2/5">
